    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 py-24 min-h-screen">
        <header className="flex justify-between items-start mb-20">
          ...
          <button 
            onClick={onClose} 
            className="p-6 bg-white/10 hover:bg-red-500/20 border border-white/10 rounded-full text-white transition-all backdrop-blur-xl group overflow-hidden"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-12">
            <section className="bg-[#1e293b]/40 backdrop-blur-2xl rounded-[3.5rem] p-12 border border-white/10 shadow-2xl">
                ...
                <div className="space-y-10">
                    <div className="grid grid-cols-4 gap-4">
                        {[
                            ...
                            <div key={t.label} className="text-center bg-white/[0.03] p-4 rounded-2xl border border-white/[0.05]">
                        ...
                        <div className="space-y-4">
                            {ELECTION_TIMELINE.map((item, i) => (
                                <div key={i} className={cn(
                                    "flex items-center gap-4 p-4 rounded-2xl border transition-all overflow-hidden",
                                    item.status === 'On-Going' ? "bg-civic-saffron/10 border-civic-saffron/30 shadow-lg shadow-civic-saffron/5" : "bg-white/[0.03] border-white/[0.05] opacity-60"
                                )}>
                                    <div className={cn(
          ...
          <div className="lg:col-span-7 bg-[#1e293b]/40 backdrop-blur-2xl rounded-[3.5rem] p-16 border border-white/10 shadow-2xl">
            ...
            <div className="space-y-5">
                {FORMS_LIBRARY.map(form => (
                    <div key={form.id} className="group p-8 bg-white/[0.03] border border-white/[0.05] rounded-[2.5rem] hover:bg-white/[0.08] hover:border-white/20 transition-all flex items-center justify-between shadow-sm overflow-hidden">
                        <div className="flex items-center gap-8">
                            <div className="w-16 h-16 bg-white/[0.05] rounded-2xl flex items-center justify-center group-hover:bg-white group-hover:text-civic-navy text-white transition-all shadow-xl">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-white/40 font-medium leading-relaxed max-w-sm">{form.desc}</p>
                            </div>
                        </div>
                        <div className="flex gap-4">
                            <a 
                              ...
                              className="p-5 bg-white/[0.05] hover:bg-civic-saffron hover:text-civic-navy rounded-2xl text-white transition-all shadow-lg active:scale-95" 
            ...
            <div className="mt-12 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {SOVEREIGN_RESOURCES.map(resource => (
                        <div key={resource.id} className="p-8 bg-white/[0.03] border border-white/[0.05] rounded-[2.5rem] hover:bg-white/[0.08] transition-all group overflow-hidden">
            ...
            <div className="mt-12 p-10 bg-white/[0.03] rounded-[3rem] border border-white/[0.05] flex items-center gap-8 relative overflow-hidden">
